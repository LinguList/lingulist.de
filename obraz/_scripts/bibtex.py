        ...
        for key in self._dict.keys():
            ...
            if len(authors) > 2:
                entry['author_str'] = '{0}, {1}, and {2}'.format(
                        authors[0][1] + ', ' + authors[0][0],
                        ', '.join([a+' '+b for a,b in authors[1:-1]]),
                        authors[-1][0] + ' '+authors[-1][1])
            elif len(authors) == 2: 
                entry['author_str'] = authors[0][1] + ', ' + authors[0][0]
                entry['author_str'] += ' and '+ authors[1][0] + ' '+ authors[1][1]
            elif authors:
                entry['author_str'] = authors[0][1] + ', ' + authors[0][0]
            ...
            if len(editors) > 2:
                entry['editor_str'] = '{0}, {1}, and {2}'.format(
                        editors[0][1] + ', ' + editors[0][0],
                        ', '.join([a+' '+b for a,b in editors[1:-1]]),
