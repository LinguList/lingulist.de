...
%  \par\nobreak\addvspace{1ex}\@afterheading}% to avoid a pagebreak after the heading
	  ...
	  \fancyhead[l]{\footnotesize J.-M. List -- Curriculumn Vitae}
	    \fancyfoot[r]{ }
	    }
...
\textbf{Johann-Mattis List -- Curriculum Vitae}\\ 
\noindent\begin{tabbing}
    gener.formation \= and \kill
    \footnotesize Date of Birth:                      \> 16.07.1981 \\
    \footnotesize Place of Birth:                      \> Kassel \\
    %\footnotesize Address:                         \> 48 rue des Martyrs \\
    %\footnotesize                                  \> 75009 Paris \\
    %\footnotesize Telephone:                        \> +49-1575-2057010 \\
...
\section{Research}
\cventry{{\footnotesize since 01/2015}}{Research Fellow}{Centre de Recherches Linguistiques
sur l'Asie Orientale (École des Hautes Études en Sciences Sociales)}{Paris}{France}{Research
fellow funded for two years by the German Research Foundation.}
\cventry{{\footnotesize 10/2012--12/2014}}{Research Assistant}{Philipps-Universität}{Marburg}{}{Research
...
\section{Teaching}
\input{courses}
\section{Supervisor of Bachelor and Master Theses}
...
\section{Reviewer for Academic Journals and Conferences}
\begin{itemize}
  \item \href{Language Dynamics and
    Change}{http://booksandjournals.brillonline.com/content/journals/22105832}
  \item \href{Linguistics}{http://www.degruyter.com/view/j/ling}
  \item \href{BioEssays}{http://onlinelibrary.wiley.com/journal/10.1002}
  \item \href{Proceedings B}{http://rspb.royalsocietypublishing.org/}
  %\item \href{Africana
  %  Linguistica}{http://poj.peeters-leuven.be/content.php?url=journal&journal_code=AL}
  \item \href{Quantitative Investigations in Theoretical
    Linguistics}{http://www2.sfs.uni-tuebingen.de/qitl/}(program committee 2015)
\end{itemize}
...
\cventry{{\footnotesize 02/2009}}{Graduate Scholarship}{German Academic Exchange Service}{Bonn}{}{
Scholarship for up two years of studies in China. \textbf{[declined]}}{}
...
\cventry{{\footnotesize 09/2005--08/2006}}{Exchange Scholarship}{Freie University Berlin / Fúdàn
...
%\cventry{{\footnotesize 20.08.2005}}{Lilalu Circus Pri 2005}{}{München}{\em Zweiter
...
\cvlanguage{{\footnotesize Graphics}}{\hspace{0.0cm}PSTricks, GIMP, InkScape}{}
