...
verglichen.}
\section{Forschung}
\cventry{ {\footnotesize since 1/2015}}{Forschungsstipendiat}{Centre de Recherches Linguistiques sur l’Asie Orientale (École des Hautes
Études en Sciences Sociales}{Paris}{}{Forschungsstipendiat (Post-Doc), gefördert für zwei Jahre von
der Deutschen Forschungsgemeinschaft.}
\cventry{{\footnotesize 10/2012--12/2014}}{Wissenschaftlicher Angestellter}{Philipps-Universität}{Marburg}{}{Mitarbeiter
(Post-Doktorand)
...
\section{Gutachter für Zeitschriften und Konferenzen}
\begin{itemize}
  \item \href{http://booksandjournals.brillonline.com/content/journals/22105832}{Language Dynamics
    and Change}
  \item \href{http://www.degruyter.com/view/j/ling}{Linguistics}
  \item \href{http://onlinelibrary.wiley.com/journal/10.1002}{BioEssays}
  \item \href{http://rspb.royalsocietypublishing.org/}{Proceedings B}
  \item \href{http://poj.peeters-leuven.be/content.php?url=journal&journal_code=AL}{Africana
    Linguistic}
  \item \href{http://www2.sfs.uni-tuebingen.de/qitl/}{Quantitative Investigations in Theoretical
    Linguistics} (program committee 2015)
\end{itemize}
